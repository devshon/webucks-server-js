...
export namespace Prisma {
  ...
  */
  ...
  export type ProductsSelect = {
    ...
    ProductImages?: boolean | ProductImagesFindManyArgs
  ...
  export class Prisma__ProductsClient<T> implements PrismaPromise<T> {
    ...
    ProductImages<T extends ProductImagesFindManyArgs = {}>(args?: Subset<T, ProductImagesFindManyArgs>): CheckSelect<T, PrismaPromise<Array<ProductImages>>, PrismaPromise<Array<ProductImagesGetPayload<T>>>>;
  ...
  export type ProductImagesGroupByArgs = {
    ...
    by: Array<ProductImagesScalarFieldEnum>
  ...
  type GetProductImagesGroupByPayload<T extends ProductImagesGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type ProductImagesGetPayload<
    S extends boolean | null | undefined | ProductImagesArgs,
    U = keyof S
      > = S extends true
        ? ProductImages
    : S extends undefined
    ? never
    : S extends ProductImagesArgs | ProductImagesFindManyArgs
    ?'include' extends U
    ? ProductImages  & {
    [P in TrueKeys<S['include']>]:
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'products' ? ProductsGetPayload<S['select'][P]> :  P extends keyof ProductImages ? ProductImages[P] : never
  } 
    : ProductImages
  : ProductImages


  type ProductImagesCountArgs = Merge<
    Omit<ProductImagesFindManyArgs, 'select' | 'include'> & {
      select?: ProductImagesCountAggregateInputType | true
    }
  >

  export interface ProductImagesDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'ProductImages'> extends True ? CheckSelect<T, Prisma__ProductImagesClient<ProductImages>, Prisma__ProductImagesClient<ProductImagesGetPayload<T>>> : CheckSelect<T, Prisma__ProductImagesClient<ProductImages | null >, Prisma__ProductImagesClient<ProductImagesGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'ProductImages'> extends True ? CheckSelect<T, Prisma__ProductImagesClient<ProductImages>, Prisma__ProductImagesClient<ProductImagesGetPayload<T>>> : CheckSelect<T, Prisma__ProductImagesClient<ProductImages | null >, Prisma__ProductImagesClient<ProductImagesGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<ProductImages>>, PrismaPromise<Array<ProductImagesGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__ProductImagesClient<ProductImages>, Prisma__ProductImagesClient<ProductImagesGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends ProductImagesAggregateArgs>(args: Subset<T, ProductImagesAggregateArgs>): PrismaPromise<GetProductImagesAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, ProductImagesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProductImagesGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ProductImagesClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type ProductImagesFindUniqueArgs = {
    /**
    ...
    **/
    ...
    /**
     * Throw an Error if a ProductImages can't be found
     * 
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
   ...
   */
  export type ProductImagesFindFirstArgs = {
    /**
     * Select specific fields to fetch from the ProductImages
     * 
    **/
  ...
  export type ProductsCreateInput = {
    ...
    Nutritions?: NutritionsCreateNestedManyWithoutProductsInput
  }
  ...
  export type ProductsUncheckedCreateInput = {
    ...
    Nutritions?: NutritionsUncheckedCreateNestedManyWithoutProductsInput
  }
  ...
  export type ProductsUpdateInput = {
    ...
    ProductImages?: ProductImagesUpdateManyWithoutProductsInput
    ProductsAllergies?: ProductsAllergiesUpdateManyWithoutProductsInput
    Nutritions?: NutritionsUpdateManyWithoutProductsInput
  }
  ...
  export type ProductsUncheckedUpdateInput = {
    ...
    created_at?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    ProductImages?: ProductImagesUncheckedUpdateManyWithoutProductsInput
    ProductsAllergies?: ProductsAllergiesUncheckedUpdateManyWithoutProductsInput
    Nutritions?: NutritionsUncheckedUpdateManyWithoutProductsInput
  }
  ...
  export type ProductImagesUpdateInput = {
    ...
    created_at?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    products?: ProductsUpdateOneRequiredWithoutProductImagesInput
  }
  ...
  export type ProductImagesCreateNestedManyWithoutProductsInput = {
    create?: XOR<Enumerable<ProductImagesCreateWithoutProductsInput>, Enumerable<ProductImagesUncheckedCreateWithoutProductsInput>>
    connectOrCreate?: Enumerable<ProductImagesCreateOrConnectWithoutProductsInput>
  ...
  export type NutritionsCreateNestedManyWithoutProductsInput = {
    create?: XOR<Enumerable<NutritionsCreateWithoutProductsInput>, Enumerable<NutritionsUncheckedCreateWithoutProductsInput>>
    connectOrCreate?: Enumerable<NutritionsCreateOrConnectWithoutProductsInput>
    createMany?: NutritionsCreateManyProductsInputEnvelope
  ...
  export type NutritionsUncheckedCreateNestedManyWithoutProductsInput = {
    create?: XOR<Enumerable<NutritionsCreateWithoutProductsInput>, Enumerable<NutritionsUncheckedCreateWithoutProductsInput>>
    connectOrCreate?: Enumerable<NutritionsCreateOrConnectWithoutProductsInput>
    createMany?: NutritionsCreateManyProductsInputEnvelope
    connect?: Enumerable<NutritionsWhereUniqueInput>
  ...
  export type ProductImagesUpdateManyWithoutProductsInput = {
    create?: XOR<Enumerable<ProductImagesCreateWithoutProductsInput>, Enumerable<ProductImagesUncheckedCreateWithoutProductsInput>>
    connectOrCreate?: Enumerable<ProductImagesCreateOrConnectWithoutProductsInput>
    upsert?: Enumerable<ProductImagesUpsertWithWhereUniqueWithoutProductsInput>
    createMany?: ProductImagesCreateManyProductsInputEnvelope
    ...
    connect?: Enumerable<ProductImagesWhereUniqueInput>
    update?: Enumerable<ProductImagesUpdateWithWhereUniqueWithoutProductsInput>
    updateMany?: Enumerable<ProductImagesUpdateManyWithWhereWithoutProductsInput>
  ...
  export type NutritionsUpdateManyWithoutProductsInput = {
    create?: XOR<Enumerable<NutritionsCreateWithoutProductsInput>, Enumerable<NutritionsUncheckedCreateWithoutProductsInput>>
    connectOrCreate?: Enumerable<NutritionsCreateOrConnectWithoutProductsInput>
    upsert?: Enumerable<NutritionsUpsertWithWhereUniqueWithoutProductsInput>
    createMany?: NutritionsCreateManyProductsInputEnvelope
    ...
    connect?: Enumerable<NutritionsWhereUniqueInput>
    update?: Enumerable<NutritionsUpdateWithWhereUniqueWithoutProductsInput>
    updateMany?: Enumerable<NutritionsUpdateManyWithWhereWithoutProductsInput>
  ...
  export type NutritionsUncheckedUpdateManyWithoutProductsInput = {
    create?: XOR<Enumerable<NutritionsCreateWithoutProductsInput>, Enumerable<NutritionsUncheckedCreateWithoutProductsInput>>
    connectOrCreate?: Enumerable<NutritionsCreateOrConnectWithoutProductsInput>
    upsert?: Enumerable<NutritionsUpsertWithWhereUniqueWithoutProductsInput>
    createMany?: NutritionsCreateManyProductsInputEnvelope
  ...
  export type ProductsUpdateOneRequiredWithoutProductImagesInput = {
    create?: XOR<ProductsCreateWithoutProductImagesInput, ProductsUncheckedCreateWithoutProductImagesInput>
    connectOrCreate?: ProductsCreateOrConnectWithoutProductImagesInput
  ...
  export type ProductImagesCreateManyProductsInputEnvelope = {
    data: Enumerable<ProductImagesCreateManyProductsInput>
    skipDuplicates?: boolean
  }
  ...
  export type NutritionsCreateManyProductsInputEnvelope = {
    data: Enumerable<NutritionsCreateManyProductsInput>
    skipDuplicates?: boolean
  }
  ...
  export type NutritionsUpsertWithWhereUniqueWithoutProductsInput = {
    where: NutritionsWhereUniqueInput
    update: XOR<NutritionsUpdateWithoutProductsInput, NutritionsUncheckedUpdateWithoutProductsInput>
    create: XOR<NutritionsCreateWithoutProductsInput, NutritionsUncheckedCreateWithoutProductsInput>
  }

  export type NutritionsUpdateWithWhereUniqueWithoutProductsInput = {
    where: NutritionsWhereUniqueInput
    data: XOR<NutritionsUpdateWithoutProductsInput, NutritionsUncheckedUpdateWithoutProductsInput>
  }

  export type NutritionsUpdateManyWithWhereWithoutProductsInput = {
  ...
  export type NutritionsCreateManyProductsInput = {
    id?: number
    caffein: number
    fat: number
    sugar: number
